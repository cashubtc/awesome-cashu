...
- [Cashu-redeem (newer)](https://redeem.cashu.me/)) is a webtool that enables you to redeem Cashu v4 tokens and decode emojis to redeem Cashu tokens directly into your Lightning wallet.  It has support for bitcoin connect (NWC) and also stores change n localstorage. 
